...
## Metadata
- Source URL: https://arxiv.org/html/2605.18747v1
- Canonical abstract URL: https://arxiv.org/abs/2605.18747v1
- PDF URL: https://arxiv.org/pdf/2605.18747v1
...
- Submitted UTC: Mon, 18 May 2026 17:59:03 UTC
...
- Code URL: https://github.com/YennNing/Awesome-Code-as-Agent-Harness-Papers
- Captured at: 2026-05-26T02:16:56.276624+00:00
...
1University of Illinois Urbana-Champaign    2Meta    3Stanford University
† Core Contributor
...
Goedel-Code-Prover [li2026goedel]
Formal
Lean code proof
...
Repo graph
Critique
VerilogCoder [ho2025verilogcoder]
Structure-grounded
Task-circuit relation graph
Repo graph
Test pass/fail
Tree-of-Code [ni2024treeofcode]
Search-based
Trajectory tree search
Execution env
Test pass/fail
ReThinkMCTS [li2025rethinkmcts]
Search-based
...
with a targeted summary of prior progress (Mr​s)(M_{rs}) rather than
...
Repository, execution (formal Sk/BkS_{k}/B_{k})
...
state SkS_{k} and measure the divergence between SkS_{k} and an
agent’s belief state BkB_{k}.
...
belief divergence |Bk−Sk||B_{k}-S_{k}|, proposing explicit
...
Retrieval-augmented completion [zhang2023repocoder], graph-based code indexing [liu2024codexgraphbridginglargelanguage], documentation-oriented agents such as RepoAgent [luo-etal-2024-repoagent], and recent context-retrieval benchmarks such as ContextBench [li2026contextbench] instantiate the memory abstractions of §3.2 with a code-specific twist: stored items such as functions, tests, traces, and retrieved issue contexts are themselves executable or directly tied to executable states, and can be re-run, checked, or localized rather than merely re-read.
...
[tang2024codeagent, Baqar_2025]. At production scale,
