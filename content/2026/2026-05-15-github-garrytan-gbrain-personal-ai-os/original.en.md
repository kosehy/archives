...
## Repository preservation metadata

- Requested URL: https://github.com/garrytan/gbrain
- Canonical repository: garrytan/gbrain
- Canonical URL: https://github.com/garrytan/gbrain
- API URL: https://api.github.com/repos/garrytan/gbrain
- Fetched at: 2026-05-15 10:18:34 KST
- Default branch: `master`
- Extraction method: GitHub REST API + raw README manual capture
- Quality status: good
...
## Fetch-time repository snapshot

- Stars: 15,659
- Forks: 2,098
- Open issues: 423
- Watchers/subscribers count fields: watchers=15,659, subscribers=68
- Created: 2026-04-05T14:40:56Z
- Updated: 2026-05-15T01:22:16Z
- Pushed: 2026-05-15T01:22:19Z
- Archived: False
- Disabled: False
- Visibility: public
- Recursive tree entries: 1,399
- Recursive tree truncated: False
- Releases fetched: 0
- Tags fetched: 0
- GitHub Actions workflows: 5
- GitHub Actions runs reported by API total_count: 2626

## Language mix

- TypeScript: 8,746,887 bytes (98.0%)
- Shell: 114,107 bytes (1.3%)
- PLpgSQL: 46,171 bytes (0.5%)
- CSS: 8,006 bytes (0.1%)
- JavaScript: 6,923 bytes (0.1%)
- HTML: 565 bytes (0.0%)

## Package/runtime signals

- Package name: `gbrain`
- Package version: `0.33.3.0`
- Package description: Postgres-native personal knowledge brain with hybrid RAG search
- Module type: `module`
- CLI bin: `{"gbrain": "src/cli.ts"}`
- Dependency count: 27
- Dev dependency count: 6
- Notable scripts: `dev, build, build:all, build:admin, build:schema, build:llms, build:pglite-snapshot, test, test:full, verify, check:system-of-record, check:admin-scope-drift, check:cli-exec, check:all, check:wasm, check:newlines, test:e2e, test:slow, test:profile, test:serial, ci:local, ci:local:diff, ci:select-e2e, typecheck`

## Workflow snapshot

- E2E Tests (active): `.github/workflows/e2e.yml`
- Eval tests (active): `.github/workflows/eval-tests.yml`
- Release (active): `.github/workflows/release.yml`
- Test (active): `.github/workflows/test.yml`
- Copilot code review (active): `dynamic/copilot-pull-request-reviewer/copilot-pull-request-reviewer`

Recent runs at fetch time:

- 2026-05-15T01:22:24Z `E2E Tests` on `garrytan/managua-v3` via pull_request: queued/None - https://github.com/garrytan/gbrain/actions/runs/25895057034
- 2026-05-15T01:22:24Z `Test` on `garrytan/managua-v3` via pull_request: queued/None - https://github.com/garrytan/gbrain/actions/runs/25895057020
- 2026-05-15T01:20:07Z `E2E Tests` on `garrytan/cape-town-v4` via pull_request: in_progress/None - https://github.com/garrytan/gbrain/actions/runs/25894992402
- 2026-05-15T01:20:07Z `Test` on `garrytan/cape-town-v4` via pull_request: in_progress/None - https://github.com/garrytan/gbrain/actions/runs/25894992394
- 2026-05-15T01:18:12Z `Test` on `garrytan/santiago-v2` via pull_request: in_progress/None - https://github.com/garrytan/gbrain/actions/runs/25894937188
- 2026-05-15T01:18:12Z `E2E Tests` on `garrytan/santiago-v2` via pull_request: completed/success - https://github.com/garrytan/gbrain/actions/runs/25894937187
- 2026-05-15T00:04:50Z `Test` on `diazMelgarejo-session-pooler-ddl` via pull_request: completed/action_required - https://github.com/garrytan/gbrain/actions/runs/25892758847
- 2026-05-15T00:04:49Z `E2E Tests` on `diazMelgarejo-session-pooler-ddl` via pull_request: completed/action_required - https://github.com/garrytan/gbrain/actions/runs/25892758514
- 2026-05-15T00:02:13Z `E2E Tests` on `diazMelgarejo-ipv6-fix` via pull_request: completed/action_required - https://github.com/garrytan/gbrain/actions/runs/25892674982
- 2026-05-15T00:02:13Z `Test` on `diazMelgarejo-ipv6-fix` via pull_request: completed/action_required - https://github.com/garrytan/gbrain/actions/runs/25892674959
- 2026-05-14T23:50:53Z `Test` on `master` via push: completed/success - https://github.com/garrytan/gbrain/actions/runs/25892299563
- 2026-05-14T23:50:53Z `E2E Tests` on `master` via push: completed/failure - https://github.com/garrytan/gbrain/actions/runs/25892299562
...
- Directories: 150
- Workflow files: 3
- Docs-path entries: 84
- Eval-related path entries: 107
- Skill directory count heuristic: 51

See `tree-snapshot.md` for the full recursive tree path list and `github-api-metadata.json` for the raw API bundle.

## README self-description claim lines

The following are count- or capability-bearing lines preserved from the official README. Treat them as repository self-description at fetch time unless independently replayed or audited.
