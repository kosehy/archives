...
- Forks: 280
- Open issues: 58
- Created at: 2026-01-14T01:14:04Z
- Updated at: 2026-05-02T05:32:31Z
- Pushed at: 2026-05-01T16:46:15Z
- Archived: False

## Source tree snapshot

- Total Git tree entries: 869
- Tree truncated by GitHub API: False
- Top-level path entry counts: `tests` 343, `src` 338, `docs` 45, `skills` 39, `crates` 18, `commands` 14, `examples` 13, `.github` 11, `scripts` 11, `.ouroboros` 5, `.claude-plugin` 4, `.claude` 2, `hooks` 2, `tools` 2, `.env.example` 1, `.gitignore` 1, `.mcp.json` 1, `.pre-commit-config.yaml` 1, `.python-version` 1, `CHANGELOG.md` 1
- Most common file extensions: `.py` 570, `.md` 105, `.rs` 10, `.yml` 9, `.yaml` 9, `.json` 8, `[no extension]` 4, `.toml` 3, `.sh` 3, `.ts` 3, `.lock` 2, `.txt` 2, `.sql` 2, `.example` 1, `.png` 1

### First 120 tree entries

- tree: `.claude-plugin`
- blob: `.claude-plugin/.mcp.json` (179 bytes)
- blob: `.claude-plugin/marketplace.json` (1051 bytes)
- blob: `.claude-plugin/plugin.json` (628 bytes)
- tree: `.claude`
- blob: `.claude/settings.json` (555 bytes)
- blob: `.env.example` (1658 bytes)
- tree: `.github`
- tree: `.github/ISSUE_TEMPLATE`
- blob: `.github/ISSUE_TEMPLATE/bug_report.yml` (3052 bytes)
- blob: `.github/ISSUE_TEMPLATE/config.yml` (326 bytes)
- blob: `.github/ISSUE_TEMPLATE/feature_request.yml` (3357 bytes)
- blob: `.github/ISSUE_TEMPLATE/question.yml` (1723 bytes)
- tree: `.github/workflows`
- blob: `.github/workflows/dev-publish.yml` (3056 bytes)
- blob: `.github/workflows/lint.yml` (1798 bytes)
- blob: `.github/workflows/release.yml` (4124 bytes)
- blob: `.github/workflows/test.yml` (1189 bytes)
- blob: `.gitignore` (1859 bytes)
- blob: `.mcp.json` (157 bytes)
- tree: `.ouroboros`
- blob: `.ouroboros/mechanical.toml` (96 bytes)
- tree: `.ouroboros/seeds`
- blob: `.ouroboros/seeds/seed_73827177a2a3.yaml` (5032 bytes)
- blob: `.ouroboros/seeds/seed_78c8e6e41813.yaml` (6790 bytes)
- blob: `.pre-commit-config.yaml` (687 bytes)
- blob: `.python-version` (5 bytes)
- blob: `CHANGELOG.md` (13139 bytes)
- blob: `CLAUDE.md` (4139 bytes)
- blob: `CODE_OF_CONDUCT.md` (1370 bytes)
- blob: `CONTRIBUTING.md` (31054 bytes)
- blob: `Code-Review-Claude.md` (17789 bytes)
- blob: `Code-Review-Codex.md` (13900 bytes)
- blob: `HANDOFF.md` (3616 bytes)
- blob: `LICENSE` (1060 bytes)
- blob: `README.ko.md` (17379 bytes)
- blob: `README.md` (21514 bytes)
- blob: `SECURITY.md` (2709 bytes)
- blob: `UNINSTALL.md` (2446 bytes)
- tree: `commands`
- blob: `commands/cancel.md` (204 bytes)
- blob: `commands/evaluate.md` (221 bytes)
- blob: `commands/evolve.md` (225 bytes)
- blob: `commands/help.md` (198 bytes)
- blob: `commands/interview.md` (251 bytes)
- blob: `commands/ralph.md` (203 bytes)
- blob: `commands/run.md` (218 bytes)
- blob: `commands/seed.md` (228 bytes)
- blob: `commands/setup.md` (189 bytes)
- blob: `commands/status.md` (206 bytes)
- blob: `commands/tutorial.md` (196 bytes)
- blob: `commands/unstuck.md` (228 bytes)
- blob: `commands/welcome.md` (324 bytes)
- tree: `crates`
- tree: `crates/ouroboros-tui`
- blob: `crates/ouroboros-tui/.gitignore` (8 bytes)
- blob: `crates/ouroboros-tui/Cargo.lock` (13800 bytes)
- blob: `crates/ouroboros-tui/Cargo.toml` (460 bytes)
- blob: `crates/ouroboros-tui/README.md` (1264 bytes)
- tree: `crates/ouroboros-tui/src`
- blob: `crates/ouroboros-tui/src/db.rs` (44640 bytes)
- blob: `crates/ouroboros-tui/src/main.rs` (20500 bytes)
- blob: `crates/ouroboros-tui/src/mock.rs` (20677 bytes)
- blob: `crates/ouroboros-tui/src/state.rs` (20739 bytes)
- tree: `crates/ouroboros-tui/src/views`
- blob: `crates/ouroboros-tui/src/views/dashboard.rs` (14971 bytes)
- blob: `crates/ouroboros-tui/src/views/execution.rs` (12823 bytes)
- blob: `crates/ouroboros-tui/src/views/lineage.rs` (22892 bytes)
- blob: `crates/ouroboros-tui/src/views/logs.rs` (2718 bytes)
- blob: `crates/ouroboros-tui/src/views/mod.rs` (95 bytes)
- blob: `crates/ouroboros-tui/src/views/session_selector.rs` (3852 bytes)
- tree: `docs`
- blob: `docs/README.md` (4818 bytes)
- tree: `docs/api`
- blob: `docs/api/README.md` (1717 bytes)
- blob: `docs/api/core.md` (10446 bytes)
- blob: `docs/api/mcp.md` (22999 bytes)
- blob: `docs/architecture.md` (28750 bytes)
- blob: `docs/cli-reference.md` (25435 bytes)
- blob: `docs/config-reference.md` (30759 bytes)
- tree: `docs/contributing`
- blob: `docs/contributing/agent-os-kernel-terminology.md` (4409 bytes)
- blob: `docs/contributing/architecture-overview.md` (7015 bytes)
- blob: `docs/contributing/findings-registry.md` (65286 bytes)
- blob: `docs/contributing/issue-quality-policy.md` (1388 bytes)
- blob: `docs/contributing/key-patterns.md` (7422 bytes)
- blob: `docs/contributing/testing-guide.md` (5990 bytes)
- blob: `docs/events.md` (3898 bytes)
- tree: `docs/examples`
- blob: `docs/examples/mcp-config.yaml` (2622 bytes)
- tree: `docs/examples/workflows`
- blob: `docs/examples/workflows/design-code-verify.md` (2690 bytes)
- blob: `docs/examples/workflows/research-to-deliverable.md` (2360 bytes)
- blob: `docs/getting-started.md` (13221 bytes)
- tree: `docs/guides`
- blob: `docs/guides/evaluation-pipeline.md` (30086 bytes)
- blob: `docs/guides/evolution-loop.md` (5569 bytes)
- blob: `docs/guides/issue-176-subagent-mcp-inheritance.md` (2077 bytes)
- blob: `docs/guides/mcp-best-practices.md` (4453 bytes)
- blob: `docs/guides/mcp-bridge.md` (2278 bytes)
- blob: `docs/guides/ooo-skill-dispatch-router.md` (2225 bytes)
- blob: `docs/guides/opencode-subagent-bridge.md` (11121 bytes)
- blob: `docs/guides/qa-backends.md` (2495 bytes)
- blob: `docs/guides/seed-authoring.md` (26046 bytes)
- blob: `docs/guides/tui-usage.md` (6728 bytes)
- tree: `docs/images`
- blob: `docs/images/PLACEHOLDER_README.md` (1091 bytes)
- blob: `docs/images/ouroboros.png` (7699814 bytes)
- blob: `docs/platform-support.md` (3025 bytes)
- blob: `docs/runtime-capability-matrix.md` (12829 bytes)
- tree: `docs/runtime-guides`
- blob: `docs/runtime-guides/claude-code.md` (4546 bytes)
- blob: `docs/runtime-guides/codex.md` (12877 bytes)
- blob: `docs/runtime-guides/gemini.md` (5740 bytes)
- blob: `docs/runtime-guides/hermes.md` (2174 bytes)
- blob: `docs/runtime-guides/opencode.md` (19009 bytes)
- tree: `examples`
- blob: `examples/coordinator_test_seed.yaml` (4248 bytes)
- blob: `examples/dummy_seed.yaml` (743 bytes)
- blob: `examples/parallel_subac_test_seed.yaml` (3060 bytes)

## README.md (English, captured from raw.githubusercontent.com)
...
| Step          | Before                  | After                                                                   |
| :------------ | :---------------------- | :---------------------------------------------------------------------- |
| **Interview** | _"Build me a task CLI"_ | 12 hidden assumptions exposed, ambiguity scored to 0.19                 |
...
| :------------------ | :--------------------------------------- | :------------------------------------------------------------------------------ |
| **Vague prompt**    | AI guesses intent, builds on assumptions | Socratic interview forces clarity _before_ code                                 |
...
| **Evolve**    | Wonder _("What do we still not know?")_ -> Reflect -> next generation |

> _"This is where the Ouroboros eats its tail: the output of evaluation_
> _becomes the input for the next generation's seed specification."_
> -- `reflect.py`
...
| `ooo seed`           | _(generated by interview)_                                        | Crystallize into immutable spec                              |
| `ooo run`            | `ouroboros run seed.yaml`                                         | Execute via Double Diamond decomposition                     |
| `ooo evaluate`       | _(via MCP)_                                                       | 3-stage verification gate                                    |
| `ooo evolve`         | _(via MCP)_                                                       | Evolutionary loop until ontology converges                   |
| `ooo unstuck`        | _(via MCP)_                                                       | 5 lateral thinking personas when you are stuck               |
...
| `ooo ralph`          | _(via MCP)_                                                       | Persistent loop until verified                               |
| `ooo tutorial`       | _(interactive)_                                                   | Interactive hands-on learning                                |
| `ooo help`           | `ouroboros --help`                                                | Full reference                                               |
| `ooo pm`             | _(via MCP)_                                                       | PM-focused interview + PRD generation                        |
| `ooo qa`             | _(via skill)_                                                     | General-purpose QA verdict for any artifact                  |
| `ooo update`         | `ouroboros update`                                                | Check for updates + upgrade to latest                        |
| `ooo brownfield`     | _(via skill)_                                                     | Scan and manage brownfield repo/worktree defaults            |
| `ooo publish`        | _(skill/runtime surface; uses `gh` CLI)_                          | Publish a Seed as GitHub Epic/Task issues for team workflows |
...
| :----------------------- | :--------------------------------- | :-------------------------------------------------- |
| **Socratic Interviewer** | Questions-only. Never builds.      | _"What are you assuming?"_                          |
| **Ontologist**           | Finds essence, not symptoms        | _"What IS this, really?"_                           |
| **Seed Architect**       | Crystallizes specs from dialogue   | _"Is this complete and unambiguous?"_               |
| **Evaluator**            | 3-stage verification               | _"Did we build the right thing?"_                   |
| **Contrarian**           | Challenges every assumption        | _"What if the opposite were true?"_                 |
| **Hacker**               | Finds unconventional paths         | _"What constraints are actually real?"_             |
| **Simplifier**           | Removes complexity                 | _"What's the simplest thing that could work?"_      |
| **Researcher**           | Stops coding, starts investigating | _"What evidence do we actually have?"_              |
| **Architect**            | Identifies structural causes       | _"If we started over, would we build it this way?"_ |
...
> _Wonder -> "How should I live?" -> "What IS 'live'?" -> Ontology_
> -- Socrates

Every great question leads to a deeper question -- and that deeper question is always **ontological**: not _"how do I do this?"_ but _"what IS this, really?"_
...
This is not abstraction for its own sake. When you answer _"What IS a task?"_ -- deletable or archivable? solo or team? -- you eliminate an entire class of rework. **The ontological question is the most practical question.**
...
| :------------------------------------------------------------ | :--------: | :--------: |
| **Goal Clarity** -- _Is the goal specific?_                   |    40%     |    35%     |
| **Constraint Clarity** -- _Are limitations defined?_          |    30%     |    25%     |
| **Success Criteria** -- _Are outcomes measurable?_            |    30%     |    25%     |
| **Context Clarity** -- _Is the existing codebase understood?_ |     --     |    15%     |
