...
- Canonical URL: https://thenewstack.io/anthropic-openai-wall-street-ai-agents-developers/
- Shared URL: https://share.google/dLbl3fbihKMTpZjK4
- Author: Darryl K. Taft
- Published: 2026-05-22T17:37:04+00:00
- Modified: 2026-05-22T17:46:25+00:00
- Archived: 2026-05-26
- Source language: English
- Categories: [AI Engineering](https://thenewstack.io/category/ai-engineering/), [AI Strategy](https://thenewstack.io/category/ai-strategy/), [Software Development](https://thenewstack.io/category/software-development/)
- Description: As Anthropic and OpenAI race to embed engineers inside Wall Street's most critical workflows, developers are caught between opportunity and disruption — and the big consultancies may be too.
- Cover image: https://cdn.thenewstack.io/media/2026/05/a3b674bc-tim-trad-p2smkbz0mtm-unsplash-scaled.jpg
- Cover image credit/caption: HandRush Supply for Unsplash+.
- Extraction method: direct HTML fetch with browser-like headers, manual extraction from `.content-column-post-body` / `.copy-column`
- Quality status: good

## Preservation notes

- The article body was extracted from The New Stack direct HTML. Navigation, newsletter/signup, ads, share widgets, related/trending blocks, scripts, and author footer were excluded.
- The submitted `share.google` URL is preserved separately; the canonical The New Stack URL is used for durable citation.
- Inline article links were preserved and common tracking parameters were removed.
- Duplicate pull-quote/plain-paragraph renderings were de-duplicated during Markdown conversion.
- The lead image is preserved as a remote URL only because it is illustrative rather than argument-bearing evidence.
...
- [Darryl K. Taft](https://thenewstack.io/author/darryl-taft/)
- [HandRush Supply](https://unsplash.com/@tehangat/illustrations)
- [Unsplash+](https://unsplash.com/plus?referrer=%2Fillustrations%2Fa-man-sitting-in-front-of-a-laptop-computer-2xfWNzi7LRk)
- [Anthropic](https://thenewstack.io/anthropic-agents-managed-aws-claude/)
- [OpenAI](https://thenewstack.io/openai-launches-a-no-code-agent-builder/)
- [financial services partnerships](https://thenewstack.io/fintech-partnership-streamlines-banking-data-integrations/)
- [acquisition of applied AI consulting firm Tomoro](https://www.linkedin.com/posts/tomoro-ai_today-were-announcing-that-tomoro-will-become-activity-7459592053048586240-Mu3o/)
- [Forward Deployed Engineers](https://thenewstack.io/forward-deployed-engineer-fde-openai-google/)
- [Brad Shimmin](https://www.linkedin.com/in/bradshimmin/)
- [Jason Cutler](https://www.linkedin.com/in/jasonrcutler/)
- [Caylent](https://caylent.com/)
- [Claude Cowork](https://thenewstack.io/anthropic-takes-claude-cowork-out-of-preview-and-straight-into-the-enterprise/)
- [Claude Code](https://thenewstack.io/anthropics-claude-code-gets-support-for-remote-mcp-servers/)
- [Sanjay Subramanian](https://www.linkedin.com/in/sanjaysubramanian/)
- [COBOL](https://thenewstack.io/how-cobol-code-can-benefit-from-machine-learning-insight/)
- [Chamath Palihapitiya](https://www.linkedin.com/in/chamath/)
- [blunt warning on X](https://x.com/chamath/status/2056074605228605580)
