...
Repository metadata snapshot: chopratejas/headroom · Python · Apache-2.0 · stars 4379 · forks 351
Default branch: `main`
Created: 2026-01-07T19:58:51Z
Updated: 2026-06-02T06:09:50Z
Pushed: 2026-06-02T00:08:41Z
...
- Captured from the GitHub API because direct page fallback extraction produced a partial shell of the page.
- `source/README.md` preserves the raw repository README captured from GitHub.
- `source/repo-metadata.json` preserves the repository metadata API response.
- `source/repo-tree.json` and `source/repo-file-list.txt` preserve a file-tree snapshot.
- Local README media referenced in the main body was recovered into `figures/` and linked below.
- Repository claims such as token savings and benchmark results are author/repository claims unless independently reproduced; see `source-trace.ko.md`.
