# opendataloader-project opendataloader-pdf GitHub Repository
...
- **API URL:** https://api.github.com/repos/opendataloader-project/opendataloader-pdf
- **Archived date:** 2026-04-30
- **Repository full name:** opendataloader-project/opendataloader-pdf
- **Description:** PDF Parser for AI-ready data. Automate PDF accessibility. Open-source.
- **Homepage:** https://opendataloader.org
- **Default branch:** main
- **Visibility:** public
- **Archived repository:** False
- **Disabled repository:** False
- **Fork:** False
- **License:** Apache-2.0
...
- **Updated at:** 2026-04-30T09:48:21Z
- **Pushed at:** 2026-04-30T09:49:14Z
...
- Java: 1513413 bytes (84.8%)
- Python: 175074 bytes (9.8%)
- TypeScript: 52078 bytes (2.9%)
- JavaScript: 32067 bytes (1.8%)
- Shell: 12630 bytes (0.7%)

## Top-level repository contents

- `.editorconfig` (file, 187 bytes) — https://github.com/opendataloader-project/opendataloader-pdf/blob/main/.editorconfig
- `.gitattributes` (file, 272 bytes) — https://github.com/opendataloader-project/opendataloader-pdf/blob/main/.gitattributes
- `.github` (dir, 0 bytes) — https://github.com/opendataloader-project/opendataloader-pdf/tree/main/.github
- `.gitignore` (file, 863 bytes) — https://github.com/opendataloader-project/opendataloader-pdf/blob/main/.gitignore
- `CHANGELOG.md` (file, 41 bytes) — https://github.com/opendataloader-project/opendataloader-pdf/blob/main/CHANGELOG.md
- `CLAUDE.md` (file, 1606 bytes) — https://github.com/opendataloader-project/opendataloader-pdf/blob/main/CLAUDE.md
- `CODE_OF_CONDUCT.md` (file, 5505 bytes) — https://github.com/opendataloader-project/opendataloader-pdf/blob/main/CODE_OF_CONDUCT.md
- `CONTRIBUTING.md` (file, 3538 bytes) — https://github.com/opendataloader-project/opendataloader-pdf/blob/main/CONTRIBUTING.md
- `LICENSE` (file, 11358 bytes) — https://github.com/opendataloader-project/opendataloader-pdf/blob/main/LICENSE
- `LICENSE_TEMPLATE` (dir, 0 bytes) — https://github.com/opendataloader-project/opendataloader-pdf/tree/main/LICENSE_TEMPLATE
- `NOTICE` (file, 1378 bytes) — https://github.com/opendataloader-project/opendataloader-pdf/blob/main/NOTICE
- `README.md` (file, 34355 bytes) — https://github.com/opendataloader-project/opendataloader-pdf/blob/main/README.md
- `SUPPORT.md` (file, 1157 bytes) — https://github.com/opendataloader-project/opendataloader-pdf/blob/main/SUPPORT.md
- `THIRD_PARTY` (dir, 0 bytes) — https://github.com/opendataloader-project/opendataloader-pdf/tree/main/THIRD_PARTY
- `build-scripts` (dir, 0 bytes) — https://github.com/opendataloader-project/opendataloader-pdf/tree/main/build-scripts
- `docs` (dir, 0 bytes) — https://github.com/opendataloader-project/opendataloader-pdf/tree/main/docs
- `examples` (dir, 0 bytes) — https://github.com/opendataloader-project/opendataloader-pdf/tree/main/examples
- `java` (dir, 0 bytes) — https://github.com/opendataloader-project/opendataloader-pdf/tree/main/java
- `node` (dir, 0 bytes) — https://github.com/opendataloader-project/opendataloader-pdf/tree/main/node
- `options.json` (file, 7828 bytes) — https://github.com/opendataloader-project/opendataloader-pdf/blob/main/options.json
- `package.json` (file, 647 bytes) — https://github.com/opendataloader-project/opendataloader-pdf/blob/main/package.json
- `python` (dir, 0 bytes) — https://github.com/opendataloader-project/opendataloader-pdf/tree/main/python
- `samples` (dir, 0 bytes) — https://github.com/opendataloader-project/opendataloader-pdf/tree/main/samples
- `schema.json` (file, 10049 bytes) — https://github.com/opendataloader-project/opendataloader-pdf/blob/main/schema.json
- `scripts` (dir, 0 bytes) — https://github.com/opendataloader-project/opendataloader-pdf/tree/main/scripts

## Recent commits from default branch

- `590bc21` 2026-04-30T09:48:16Z — fix(node): suppress duplicated stderr re-print on Java subprocess exit (#476)
- `2d867c2` 2026-04-30T08:13:53Z — refactor(core): move CLIOptions to core api.cli package (#475)
- `c68c696` 2026-04-30T07:42:09Z — fix(hybrid): match bare "Page N" in failed-page error parser (#467)

## Recent releases

- v2.4.1 / Release v2.4.1 — published 2026-04-30T08:41:58Z — https://github.com/opendataloader-project/opendataloader-pdf/releases/tag/v2.4.1
- v2.4.0 / Release v2.4.0 — published 2026-04-29T12:44:39Z — https://github.com/opendataloader-project/opendataloader-pdf/releases/tag/v2.4.0
- v2.3.0 / Release v2.3.0 — published 2026-04-21T12:16:19Z — https://github.com/opendataloader-project/opendataloader-pdf/releases/tag/v2.3.0
- v2.2.1 / Release v2.2.1 — published 2026-04-03T09:07:51Z — https://github.com/opendataloader-project/opendataloader-pdf/releases/tag/v2.2.1
- v2.2.0 / Release v2.2.0 — published 2026-03-27T07:28:21Z — https://github.com/opendataloader-project/opendataloader-pdf/releases/tag/v2.2.0

## README

<!-- README path: README.md | size: 34355 | html: https://github.com/opendataloader-project/opendataloader-pdf/blob/main/README.md -->
