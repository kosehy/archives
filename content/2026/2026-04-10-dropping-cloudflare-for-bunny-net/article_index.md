# Dropping Cloudflare for bunny.net — Article Index
...
- The article is a practical migration note from Cloudflare to bunny.net.
- The main framing is infrastructure dependency and CDN configuration trade-offs.
