# GitHub repository: safishamsi/graphify - 공식 한국어 README

- Source URL: https://github.com/safishamsi/graphify/blob/v7/docs/translations/README.ko-KR.md
- Parent repository: https://github.com/safishamsi/graphify
- Capture note: 이 파일은 저장소가 제공하는 공식 한국어 README 번역을 원문 보존 목적으로 별도 저장한 것이다. Hermes가 생성한 번역문이 아니다.
- Saved: 2026-05-05
