...
- Incoming URL: canonicalized from newsletter URL; tracking parameters redacted in archive files
- Author: Janakiram MSV
- Published: 2026-05-10T16:36:15+00:00
- Modified: 2026-05-10T16:37:16+00:00
- Archived: 2026-05-12
- Source language: English
- Categories: [AI Agents](https://thenewstack.io/category/ai-agents/), [Developer tools](https://thenewstack.io/category/developer-tools/), [Open Source](https://thenewstack.io/category/open-source/)
- Description: Anthropic blocked third-party access, and 157,000 developers turned to OpenCode as a hedge. The move has confirmed a rising demand for model-agnostic coding.
- Cover image: https://cdn.thenewstack.io/media/2026/05/80697ecd-curated-lifestyle-mognjm4qrwq-unsplash-1-scaled.jpg
- Cover image credit/caption: Curated Lifestyle For Unsplash+
- Extraction method: direct HTML fetch with browser-like headers, manual XPath extraction from `.content-column-post-body` and `.copy-column`
- Quality status: good

## Preservation notes

- The article body was extracted from The New Stack's direct HTML. Navigation, newsletter/signup, ads, share widgets, related/trending blocks, scripts, and author footer were excluded.
- The page contained an empty `sponsored-post-disclosure` container but no visible sponsor disclosure text in the extracted article body. This is recorded because The New Stack can publish sponsored/contributed posts.
- The newsletter tracking parameters in the submitted URL were not copied into archive metadata; the canonical source URL is used for durable citation.
- The cover image is preserved as a remote URL only because it appears illustrative rather than evidence-bearing.
...
- [signed a SpaceX deal for the full capacity of the Colossus 1 data center](https://thenewstack.io/anthropic-spacex-claude-limits/)
- [routines](https://thenewstack.io/claude-code-can-now-do-your-job-overnight/)
- [SST OpenCode repository](https://github.com/sst/opencode)
- [activity page](https://github.com/anomalyco)
- [Code Review](https://thenewstack.io/anthropic-launches-a-multi-agent-code-review-tool-for-claude-code/)
- [Aider](https://thenewstack.io/open-source-coding-agents-like-opencode-cline-and-aider-are-solving-a-huge-headache-for-developers/)
