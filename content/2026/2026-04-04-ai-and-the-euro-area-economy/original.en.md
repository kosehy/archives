...
Source: https://www.ecb.europa.eu//press/key/date/2026/html/ecb.sp260323_1~1e06784a89.en.html
...
Adoption lag versus year of invention (years).
...
Share of AI patents in the United States and the euro area (percentages).
...
Euro area charges for the use of Intellectual Property Products (imports) (four-quarter moving sums in EUR billions).
...
## Impact of AI on the euro area economy
...
### Developments in digital investment
...
### AI diffusion and effects on productivity in the euro area economy
...
The speed of adoption and TFP gains over ten years (percentage points).
...
## The financial and funding dimensions of AI
...
### Stock market performance and AI intensity
...
Net purchases of US corporate listed shares by euro area residents (cumulated flows in EUR billions).
...
Notes: Panel a) shows coefficients of firm-level regressions of AI use on types of financing. Panel b) shows coefficients of firm-level regressions of expected AI investment on types of financing. Results are survey-weighted and include industry, country and firm size fixed effects. The whiskers represent 90 per cent confidence intervals. The latest observations are for the fourth quarter of 2025.
...
Notes: Cash intensity is the ratio of cash and cash equivalents to total assets. Firms are categorised according to an index accounting for both their level of AI use and AI patent production.
...
Sources: ECB datasets and ECB calculations.

Notes: Sectors are grouped into quartiles of AI-use activity and AI-related patent applications. The latest observations are for November 2025 for panel a) and for January 2026 for panel b).
...
Sources: Pitchbook, FEDS Notes and ECB calculations.

Notes: In panel a), sector shares are calculated based on average values for the period 2023-25. In panel b), private credit stock estimates use alternative maturity assumptions. The latest observations are for 31 December 2025.
...
One factor in determining the income, distribution and demand effects is whether the technological boost from AI will be labour or capital-augmenting. Technology is often modelled as labour augmenting: more can be produced with the same number of workers. This effect boosts labour income for workers, with the scale depending on their bargaining power and on institutional factors. Conversely, if AI is capital-augmenting, income increases will accrue to capital owners, rather than labour, thereby increasing inequality of labour and capital income.[69] An increase in income and wealth inequalities could limit the extent to which demand expands across all sectors of the economy and thereby dampen the inflationary tendencies associated with AI-driven productivity gains.[70]
...
Given these different mechanisms, the net effect of the AI transition on R* remains uncertain. The most recent updates to staff estimates of euro area R* do not indicate a material change.

In particular, there have been only marginal changes in the range of R* estimates since 2024 (Chart 22). The upper bound of the range of estimates based on term structure models has drifted up from 2.25 to 2.50 per cent. Conversely, the lower end of the range remained stable at 1.75 per cent, despite improvements in economic growth that contributed to a small uptick in business-cycle-related estimates of R*. Yet, elevated uncertainty, the accelerating demographic transition and still relatively sluggish productivity growth have continued to keep R\* below steady-state growth levels.

### Chart 22

Nominal equilibrium rates in the euro area (percentage per annum).

Sources: Eurosystem estimates, ECB calculations.

Notes: The chart aggregates a range of survey-based, term-structure-based and semi-structural model estimates. Latest observations run into early 2026 depending on model family.

So far, I have focused in this discussion on the implications of the AI shock for monetary policy. Taking a broader perspective, it is also important to recognise the possible amplifying impact of AI in relation to other cyclical shocks that can hit the economy. Let me outline three examples: (a) an energy shock; (b) a financial shock; and (c) a recession shock. The energy intensity of AI means that a persistent upward shock to energy prices could limit the rate of progress in building new AI models and also curtail the AI adoption rate. The capital intensity of AI production and AI adoption means that a tightening in financial conditions would also have an adverse impact on AI-producing and AI-using sectors. Finally, by offering a substitute for labour, AI could intensify labour shedding during a recession.[75]
...
These efficiency gains have helped reduce overtime work during busy survey rounds. Looking ahead, the ECB also wants to apply natural language processing techniques to the rich Corporate Telephone Survey text dataset to extract quantitative indicators and use them in economic analysis and forecasting.

Ultimately, the ECB aims to integrate AI more deeply into its policy preparation cycle: in the run-up to Governing Council meetings, AI tools can be used to scan and condense large volumes of incoming information, including economic indicators and financial market developments but also alternative information sources such as news, satellite and social media data. This helps economists in nowcasting macro-financial developments and identifying emerging patterns. After meetings, AI-enhanced tools support the efficient processing and archiving of documents to maintain institutional memory.
...
Over 2026 and 2027, the ECB will move from experimentation to the systematic implementation of AI across the institution. To this end it has developed a central banking digitalisation programme.[81] Designed as a bottom-up, business-area-driven initiative, the programme ensures that promising AI tools mature from isolated pilots into scalable institutional capabilities. It does so through three mutually reinforcing pillars. First, a data analysis hub provides an AI-ready, multi-modal data and machine-learning environment to strengthen economic, financial and market analysis. Second, the ECB is establishing an AI research lab to foster innovation, applied economic research and staff upskilling. Third, an “assistants studio” is being designed to become a workbench for building and deploying AI assistants that automate and enhance central banking business processes. Ultimately, the objective is to integrate AI into most ECB business processes.
...
- This archived version preserves the speech structure and most chart captions/notes in text form.
- The page appears to rely on embedded chart rendering rather than easily discoverable standalone image URLs from a simple scrape.
- This 1st-pass archive is text-first rather than fully figure-aware.
