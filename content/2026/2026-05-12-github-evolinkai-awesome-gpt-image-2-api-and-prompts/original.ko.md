---
title: "GitHub repository capture Korean README: EvoLinkAI/awesome-gpt-image-2-API-and-Prompts"
...
# GitHub repository capture Korean README: EvoLinkAI/awesome-gpt-image-2-API-and-Prompts

> 이 파일은 Hermes 번역본이 아니라 저장소가 제공한 공식 `README_ko.md` 원문을 보존한 것입니다.

- Requested URL: https://github.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts
- Raw URL: https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/README_ko.md
- Captured at: 2026-05-12T02:25:28.519794+00:00
- Extraction method: github_api_raw_readme_manual
- Quality status: good

## Official README_ko.md source
