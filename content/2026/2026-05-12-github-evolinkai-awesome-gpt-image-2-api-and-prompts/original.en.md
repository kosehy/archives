---
title: "GitHub repository capture: EvoLinkAI/awesome-gpt-image-2-API-and-Prompts"
source_url: "https://github.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts"
archived_at: "2026-05-12T02:25:28.519794+00:00"
source_type: "github_repository"
---

# GitHub repository capture: EvoLinkAI/awesome-gpt-image-2-API-and-Prompts

## Capture metadata

- Requested URL: https://github.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts
- Canonical API full name: EvoLinkAI/awesome-gpt-image-2-API-and-Prompts
- HTML URL: https://github.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts
- Captured at: 2026-05-12T02:25:28.519794+00:00
- Archive date: 2026-05-12
- Extraction method: github_api_raw_readme_manual
- Quality status: good
- Default branch: main
- Tree truncated: False
- Recursive tree entries captured: 1,197
- Official localized Korean README captured: yes
...
- Topics: api, awesome, awesome-list, chatgpt, generative-, gpt-image-2, gpt-image-2-api, gpt-image-2-prompts, image-generation, image-prompt, image-to-image, openai, prompt-, prompt-collection, prompts, text-to-image
- License from GitHub API: CC0-1.0 / Creative Commons Zero v1.0 Universal
- Stars at capture: 13,935
- Forks at capture: 1,382
- Watchers/subscribers field at capture: 13,935
- Open issues field at capture: 4
- Created: 2026-04-18T11:22:14Z
- Updated: 2026-05-12T02:22:43Z
- Pushed: 2026-05-11T06:15:46Z
- Archived: False
- Disabled: False
- Private: False
...
## README-derived structure

- README.md bytes: 59,096
- README_ko.md bytes: 58,351
- README heading count: 39
- README case heading count in main README: 21
- README prompt/case count strings observed: badge says `471 Curated Cases`; introduction says `359+ high-quality GPT-Image-2 prompts`; main README includes 21 visible `### Case` headings.
- Case category headings observed:
- ## 🛒 E-commerce Cases
- ## 📣 Ad Creative Cases
...
### GitHub Actions workflows sample
- None observed.
...
### Contributors sample
- EvoLinkAI (107 contributions)


## Caveats for reuse

- Star, fork, issue, updated, and pushed counts are time-sensitive GitHub API values captured at `2026-05-12T02:25:28.519794+00:00`.
- The repository README contains count strings that are not identical: the badge says `471 Curated Cases`, while the introduction says `359+ high-quality GPT-Image-2 prompts`. Treat these as repository self-description, not independently verified corpus counts.
- License metadata needs human checking before commercial reuse: GitHub API reports `CC0-1.0`, while the README badge text may describe a different license string. The preserved `LICENSE` text is included in the metadata bundle for review.
- Claims about OpenAI model naming/capabilities are preserved from the repository README; this archive did not separately verify them against OpenAI primary documentation.
- Images are preserved as GitHub raw links inside the README/tree snapshot; this run did not download all 1,000+ image assets locally.

## Official README.md source
