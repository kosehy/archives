...
- Source URL: https://eugeneyan.com/writing/working-with-ai/
- Shared URL: https://share.google/02EL7gxGCUYW5EW6j
- Final fetched URL: https://eugeneyan.com/writing/working-with-ai/
- Author: Eugene Yan
- Site: eugeneyan.com
- Published: 2026-05-03T00:00:00+00:00
- Tags / read time: [ ai productivity mechanism ] · 13 min read
- Description: Context as infra, taste as config, verification for autonomy, scale via delegation, closing the loop.
- Preview image: figures/figure-00-og-preview.jpg
- Source language: en
- Extraction method: direct_html_notebody_manual
- Quality status: good
- Preservation note: The article body was extracted from `div.notebody`; site navigation, recommendation widgets, newsletter forms, social-share icons, and footer chrome were excluded. The OG preview diagram was downloaded to `figures/` because it summarizes the article's conceptual loop.
